...
API_KEY = 'YOUR_API_KEY'  # 비트겟에서 제공하는 실제 API Key를 여기에 입력하세요
API_SECRET = 'YOUR_API_SECRET'  # 비트겟에서 제공하는 실제 API Secret을 여기에 입력하세요
...
if __name__ == '__main__':
    app.run(debug=True, port=5000)  # 로컬 서버 실행
